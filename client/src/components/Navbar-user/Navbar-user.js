      ...
      <nav className='nav-user'>
       ...
       <div className="WNP-header"><h3 className="WNP">William Navas Photo</h3></div>
        <ul>
          ...
          {(this.props.user.name !== 'Admin' ? (<li className="nav-item"><Link to="/usersite" className="nav-link" style={{ textDecoration: "none", color: "black" }}><p className="nav-hover" style={{ color: 'white', fontSize: "20px" }}><strong>{this.props.user.name}</strong></p> </Link></li>) : "")}
